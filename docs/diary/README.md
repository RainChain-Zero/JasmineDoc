...
增加了[心情子系统](../appendix/moodmechanism.md)
...
②. 增加[今天吃什么](../manual/dice!/other/whateat.md)

③. 增加[宝可梦融合](../manual/nonebot2/pokemon.md)

## V4.9.7

2023.04.10

①. 增加了`/萌图`指令以合入`/涩图来`指令，并进行了重构

②. 剧情模式第四章「众生相」

③. 剧情模式番外「星星点灯」& 新道具星幕投影灯
...
②. 修复了[NovelAi](../manual/koishi/novelai.md)的文生图

③. 修复了 mirai 框架下的协议风控错误

④. 追加新道具 八音盒

⑤. 修正好感度随时间流逝的最大削减好感为 1000

⑥. 修复亲和检定时单次增加好感超过 1000 导致亲和不清零的问题

⑦. 修复 Marai-Native 下无法发送图片的 bug
